...
# SECTION BELOW HAS BEEN COMMENTED AS IT LEADS TO MEMORY ISSUES
# IT IS RUNNING OUT OF MEMORY ON CLASSROOM MACHINES WITH 64GB RAM
# %%  ==================================================================
...
merged_df.columns
# %% Cross-tabulation of 'ATAg' and 'AC_REG_CD'
pd.crosstab(merged_df["ATAg"], merged_df["AC_REG_CD"])

# %% Plot a heatmap of the cross-tabulation of 'ATAg' and 'AC_REG_CD'
plt.figure(figsize=(30, 10), dpi=300)
sns.heatmap(pd.crosstab(merged_df["ATAg"], merged_df["FAULT_FOUND_DATE"]))
plt.show()


# %% Plot a normalized heatmap of the cross-tabulation of 'ATAg' and 'AC_REG_CD'
plt.figure(figsize=(30, 10), dpi=300)
...
# %% Plot a heatmap of the cross-tabulation of 'ATAg' and 'FAULT_FOUND_DATE'
plt.figure(figsize=(30, 10), dpi=300)
...
# %% Plot occurrences by month for a specific aircraft
# ATA_to_analyse = "09"
...
# %% Group data by aircraft and month, then plot a stacked histogram
