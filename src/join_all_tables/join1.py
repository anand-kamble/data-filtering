...
print(f"Merge 6 done, {df6.shape=}")
...
print(f"Merge 7 done, {df7.shape=}")
...
print(f"Merge 8 done, {df8.shape=}")
...
print(f"Merge 9 done, {df9.shape=}")
...
print(f"Merge 10 done, {df10.shape=}")
# %%
# MERGE 11
"""
...
print(f"Merge 11 done, {df11.shape=}")
# %%
# MERGE 12
"""
...
print(f"Merge 12 done, {df12.shape=}")
...
df13 = df12
# MISSING INV_INV
print(f"Merge 13 done, {df13.shape=}")
...
print(f"Merge 14 done, {df14.shape=}")
# %%
# MERGE 15
"""
...
print(f"Merge 15 done, {df15.shape=}")
...
print(f"Merge 16 done, {df16.shape=}")
...
print(f"Merge 17 done, {df17.shape=}")
# %%
# MERGE 18
"""
...
print(f"Merge 19 done, {df19.shape=}")
...
print(f"Merge 20 done, {df20.shape=}")
...
print(f"Merge 21 done, {df21.shape=}")
...
print(f"Merge 22 done, {df22.shape=}")
...
print(f"Merge 23 done, {df23.shape=}")
# %%
# MERGE 24
"""
...
print(f"Merge 24 done, {df24.shape=}")
quit()
